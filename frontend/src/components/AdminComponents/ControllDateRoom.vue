<template>
    <div class="absolute top-[50%] right-0 -translate-y-[40%] bg-white p-4 rounded shadow-lg w-[350px] max-w-full text-sm font-serif border z-11">
      <form
        class=""
      ...
      >
        ...
        <div class="flex flex-col mb-3 gap-2 px-1">
          <label class="flex items-center gap-2">
            <input type="radio" value="block" v-model="status" />
            Block
          </label>
          <label class="flex items-center gap-2">
